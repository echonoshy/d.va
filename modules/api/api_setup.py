...
def process_api_args(args: argparse.Namespace, app: FastAPI):
    ...
    env.get_and_update_env(args, "no_playground", False, bool)
    env.get_and_update_env(args, "no_docs", False, bool)
    ...
    threading.excepthook = lambda exctype: logger.exception("Uncaught exception", exc_info=(exctype))
